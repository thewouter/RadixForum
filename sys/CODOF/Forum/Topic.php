...
class Topic extends Forum {
    ...
    public function get_topics($cat_id, $page = 1) {
        ...
        $qry = 'SELECT p.post_id,p.omessage AS message, p.post_created, u.id, u.name AS name, u.avatar, '
                ...
                . ' t.topic_status=' . Forum::STICKY_ONLY_CATEGORY . '  ) AND '
    ...
    public function getTaggedTopics($tag, $from = 0) {
        ...
        $qry = 'SELECT p.post_id, p.omessage AS message, p.post_created, u.id, u.name as name, u.avatar, c.cat_img, c.cat_alias,'
                ...
                . ' WHERE ( t.topic_status=' . Forum::APPROVED
                . ' OR t.topic_status=' . Forum::STICKY
                . ' OR t.topic_status=' . Forum::STICKY_ONLY_CATEGORY . ') '
                . ' AND ' . $this->getViewTopicPermissionConditions()
    ...
    public function getTaggedTopicsCount($tag) {
        ...
        $status = array(Forum::APPROVED, Forum::STICKY, Forum::STICKY_ONLY_CATEGORY);
    ...
    public function get_all_topics($from = 0) {
        ...
        $qry = 'SELECT  p.post_id, p.omessage AS message, p.post_created, u.id, '
                ...
                . 'LEFT JOIN codo_users AS u ON u.id=p.uid '
                . 'LEFT JOIN codo_categories AS c ON c.cat_id=t.cat_id '
                . 'WHERE ( t.topic_status=' . Forum::APPROVED . ' OR t.topic_status=' . Forum::STICKY . ') '
                . 'AND ' . $this->getViewTopicPermissionConditions()
     ...
     */
    public function ins_topic($catid, $title, $needsModeration, $topic_status = Forum::APPROVED, $opkomst = NULL) {
        ...
        $qry = "INSERT INTO codo_topics (title, cat_id, uid, topic_created, last_post_time,topic_status, opkomst) "
                . "VALUES(:title, :catid, :uid, :created_time, :post_time, :topic_status, :opkomst )";
    ...
    public function gen_topic_arr_all_topics($topics, $search = false) {
        ...
        foreach ($topics as $topic) {
            ...
            $_topics[$i] = array(
                ...
                "safe_title" => "gg".\CODOF\Filter::URL_safe($topic['title']),
